...
if (isset($_POST['studsu'])) {
    ...
    if (isset($_POST['name1']) && isset($_POST['usn1']) && isset($_POST['mail1']) && isset($_POST['phno1']) && isset($_POST['dept1']) && isset($_POST['dob1']) && isset($_POST['gender1']) && isset($_POST['password1']) && isset($_POST['cpassword1'])) {
        ...
        $password1 = crypt($password1,'sunilnagarsonamdorji');
        $cpassword1 = crypt($cpassword1,'sunilnagarsonamdorji');
...
require 'sql.php';
        ...
        $password2 = crypt($password2,'sunilnagarsonamdorji');
        $cpassword2 = crypt( $cpassword2,'sunilnagarsonamdorji');
