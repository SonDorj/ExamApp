        ...
        $qid=$_GET["qid"];
            ...
            if($res)
            {
                ...
                while ($row = mysqli_fetch_assoc($res)) { 
                    echo $i.". ".$row["qs"]."<br>";
                    echo "<input type=\"radio\" value=\"".($j+1)."\" name=\"ans".$i.$j."\">".$row["op1"]."<br>";
                    echo "<input type=\"radio\" value=\"".($j+2)."\" name=\"ans".$i.$j."\">".$row["op2"]."<br>";               
                    echo "<input type=\"radio\" value=\"".($j+3)."\"name=\"ans".$i.$j."\">".$row["op3"]."<br>";
                    $arr[$i]=$row["answer"];         
                    $i++;                            
                }
            ...
            if(isset($_POST["submit"])){
                ...
                for($i=1;$i<=$count;$i++)
                {
                    if(isset($_POST["ans".$i.$j]) && $_POST["ans".$i.$j]==$arr[$i]){
                        $score++;
                    }
                }
